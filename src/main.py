...
def main():
    ...
    DAILY_RETENTION = os.environ.get('DAILY_RETENTION', DAILY_RETENTION)
    WEEKLY_RETENTION = os.environ.get('WEEKLY_RETENTION', WEEKLY_RETENTION)
    MONTHLY_RETENTION = os.environ.get('MONTHLY_RETENTION', MONTHLY_RETENTION)
